...
Source0  : http://links.twibright.com/download/links-2.21.tar.bz2
...
%prep
%setup -q -n links-2.21
cd %{_builddir}/links-2.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597170391
...
cp %{_builddir}/links-2.21/COPYING %{buildroot}/usr/share/package-licenses/links/095cd2f9a1768387960b0df92d8c168fea492af2
%make_install
