...
Source0  : http://links.twibright.com/download/links-2.23.tar.bz2
...
%prep
%setup -q -n links-2.23
cd %{_builddir}/links-2.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621866460
...
cp %{_builddir}/links-2.23/COPYING %{buildroot}/usr/share/package-licenses/links/095cd2f9a1768387960b0df92d8c168fea492af2
%make_install
