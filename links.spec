...
Source0  : http://links.twibright.com/download/links-2.25.tar.bz2
...
%prep
%setup -q -n links-2.25
cd %{_builddir}/links-2.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633358593
...
cp %{_builddir}/links-2.25/COPYING %{buildroot}/usr/share/package-licenses/links/095cd2f9a1768387960b0df92d8c168fea492af2
%make_install
