...
Version  : 2.26
Release  : 25
URL      : http://links.twibright.com/download/links-2.26.tar.bz2
Source0  : http://links.twibright.com/download/links-2.26.tar.bz2
...
%prep
%setup -q -n links-2.26
cd %{_builddir}/links-2.26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649689014
...
cp %{_builddir}/links-2.26/COPYING %{buildroot}/usr/share/package-licenses/links/095cd2f9a1768387960b0df92d8c168fea492af2
%make_install
