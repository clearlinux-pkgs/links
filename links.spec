...
Source0  : http://links.twibright.com/download/links-2.22.tar.bz2
...
%prep
%setup -q -n links-2.22
cd %{_builddir}/links-2.22
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616171824
...
cp %{_builddir}/links-2.22/COPYING %{buildroot}/usr/share/package-licenses/links/095cd2f9a1768387960b0df92d8c168fea492af2
%make_install
